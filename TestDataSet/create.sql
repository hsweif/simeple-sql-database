...
CREATE TABLE orders( id INT NOT NULL, customer_id INT NOT NULL, food_id INT NOT NULL, date char(10), quantity INT, PRIMARY KEY (id), FOREIGN KEY (customer_id) REFERENCES customer(id), FOREIGN KEY (food_id) REFERENCES food(id))
